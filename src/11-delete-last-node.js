/**
 * Removes the last node from the linked list and returns the head of the list.
 * If the list is empty, it returns null.
 * This operation modifies the list by traversing it to find the second-last node and updating its next pointer to null, effectively removing the last node.
